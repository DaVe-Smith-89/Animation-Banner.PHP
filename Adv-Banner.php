<?php
//coded By DaVe Smith
//follow me on github http://github.com/DaVe-Smith-89
...
$des = array("\n\033[94m\033[01m   █████╗ ██████╗ ██╗   ██╗ █████╗ ███╗   ██╗ ██████╗███████╗",
       ...
       "\n\033[39m      ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═══╝╚═╝  ╚═══╝╚══════╝╚═╝  ╚═╝",
       "\n\t\t\t\t\t\t\033[93m    php",
       "\n\n\t\033[01m\033[32m    [+] Coded By Dave Smith CYBER WARRIOR\n",
...
if ( $a == 1 ){
	$link = array("https://t.me/By_sstp",
		      "https://github.com/DaVe-Smith-89",
		      "https://www.facebook.com/groups/424580708746052/?ref=share",
		      "https://youtu.be/T7x0rfxH3n8" );
	shuffle($link);
...
elseif ( $a == 4 ){
	...
	if ( $jc == 1 ){
		system("xdg-open https://www.facebook.com/groups/424580708746052/?ref=share");
		sleep(5);
		logo();
		menu();
		}
	elseif ( $jc == 2 ){
		system("xdg-open https://t.me/By_sstp");
		sleep(5);
		logo();
		menu();
		}
...
elseif ( $a == 5 ){
	system("xdg-open http://t.me/DaVe_Smith_89");
	sleep(5);
	system("php Adv-Banner.php");
	}
